...
public class E50t1 {
    ...
    public static void main(String args[]) {
        ...
        //System.out.println(dinero + "  " + cambio[0]);

        cambio[1] = dinero / 100;
        dinero = dinero - (cambio[1] * 100);
        //System.out.println(dinero + "  " + cambio[1]);

        cambio[2] = dinero / 50;
        dinero = dinero - (cambio[2] * 50);
        //System.out.println(dinero + "  " + cambio[2]);

        cambio[3] = dinero / 20;
        dinero = dinero - (cambio[3] * 20);
        //System.out.println(dinero + "  " + cambio[3]);

        cambio[4] = dinero / 10;
        dinero = dinero - (cambio[4] * 10);
        //System.out.println(dinero + "  " + cambio[4]);

        cambio[5] = dinero / 2;
        dinero = dinero - (cambio[5] * 2);
        //System.out.println(dinero + "  " + cambio[5]);

        cambio[6] = dinero / 1;
        dinero = dinero - (cambio[6] * 1);
        //System.out.println(dinero + "  " + cambio[6]);
